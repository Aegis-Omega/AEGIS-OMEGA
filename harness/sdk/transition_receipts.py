...
through the separate verifier gate. PR-4 evidence-only CompleteVerification is
implemented in ``complete_verifier.py``; authoritative admission remains
unavailable.
"""
...
def accept_effect_evidence(_artifact: Any) -> bool:
    """Legacy/general effect admission stays fail-closed; PR-4 is evidence-only."""
    return False
