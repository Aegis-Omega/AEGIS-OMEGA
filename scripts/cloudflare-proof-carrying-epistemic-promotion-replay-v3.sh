...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/proof-carrying-epistemic-promotion-v3"
WORK="/tmp/aegis-pcep"
...
payload={
  "receipt_kind":"AEGIS_PROOF_CARRYING_EPISTEMIC_PROMOTION_REPLAY_V3",
  "transport_generation":"EXPLICIT_PARENT_EXTENSIONALITY_V3",
  "transport_generation":"CLEAN_PARENT_IMPORT_FIX_V2",
  "head_sha":head,
...
echo "AEGIS_PROOF_CARRYING_EPISTEMIC_PROMOTION_REPLAY_V3=PASS"
exit 0
