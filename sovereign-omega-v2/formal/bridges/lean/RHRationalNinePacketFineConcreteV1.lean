...
import RHFineDiagonalUpgradeV1
import RHNineBlockFineBridgeV1
import Mathlib.Tactic

/-!
AEGIS Omega -- fine-diagonal rational nine-packet coercivity V1.

This strengthens the already verified rational nine-packet finite-family
construction by replacing the 32/25 diagonal estimate with the independently
verified 5671/3200 fine-support diagonal theorem. The thirty-six cross bounds
remain unchanged at 1/100 E. The diagonal-shift bridge then yields exact
coercivity 1083/640.

Finite translated family only. No density/globalization theorem, no universal
Weil sign, and no RH conclusion.
...
namespace AEGIS.RHRationalNinePacketFineConcreteV1
...
open AEGIS.RHFineDiagonalUpgradeV1
open AEGIS.RHNineBlockComparisonV1
open AEGIS.RHNineBlockActualExpansionV1
open AEGIS.RHNineBlockFineBridgeV1

theorem translate_fine_width_exact_v1
...
theorem translated_fine_diagonal_v1
  ...
  have hd := fine_diagonal_5671_over_3200_v1
    (translatePacket g d) (a + d)
    (translate_fine_width_exact_v1 g a d hw)
  rw [translate_energy] at hd
  exact hd

theorem nine_packet_fine_coercive_v1
  ...
  exact nine_value_bound_fine_v1
    ...
    (-(B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 0))).re) (-(B (translatePacket g (qNineShiftV1 1)) (translatePacket g (qNineShiftV1 1))).re) (-(B (translatePacket g (qNineShiftV1 2)) (translatePacket g (qNineShiftV1 2))).re) (-(B (translatePacket g (qNineShiftV1 3)) (translatePacket g (qNineShiftV1 3))).re) (-(B (translatePacket g (qNineShiftV1 4)) (translatePacket g (qNineShiftV1 4))).re) (-(B (translatePacket g (qNineShiftV1 5)) (translatePacket g (qNineShiftV1 5))).re) (-(B (translatePacket g (qNineShiftV1 6)) (translatePacket g (qNineShiftV1 6))).re) (-(B (translatePacket g (qNineShiftV1 7)) (translatePacket g (qNineShiftV1 7))).re) (-(B (translatePacket g (qNineShiftV1 8)) (translatePacket g (qNineShiftV1 8))).re)
    (energy g.1)
    (B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 1))) (B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 2))) (B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 3))) (B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 4))) (B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 5))) (B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 6))) (B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 7))) (B (translatePacket g (qNineShiftV1 0)) (translatePacket g (qNineShiftV1 8))) (B (translatePacket g (qNineShiftV1 1)) (translatePacket g (qNineShiftV1 2))) (B (translatePacket g (qNineShiftV1 1)) (translatePacket g (qNineShiftV1 3))) (B (translatePacket g (qNineShiftV1 1)) (translatePacket g (qNineShiftV1 4))) (B (translatePacket g (qNineShiftV1 1)) (translatePacket g (qNineShiftV1 5))) (B (translatePacket g (qNineShiftV1 1)) (translatePacket g (qNineShiftV1 6))) (B (translatePacket g (qNineShiftV1 1)) (translatePacket g (qNineShiftV1 7))) (B (translatePacket g (qNineShiftV1 1)) (translatePacket g (qNineShiftV1 8))) (B (translatePacket g (qNineShiftV1 2)) (translatePacket g (qNineShiftV1 3))) (B (translatePacket g (qNineShiftV1 2)) (translatePacket g (qNineShiftV1 4))) (B (translatePacket g (qNineShiftV1 2)) (translatePacket g (qNineShiftV1 5))) (B (translatePacket g (qNineShiftV1 2)) (translatePacket g (qNineShiftV1 6))) (B (translatePacket g (qNineShiftV1 2)) (translatePacket g (qNineShiftV1 7))) (B (translatePacket g (qNineShiftV1 2)) (translatePacket g (qNineShiftV1 8))) (B (translatePacket g (qNineShiftV1 3)) (translatePacket g (qNineShiftV1 4))) (B (translatePacket g (qNineShiftV1 3)) (translatePacket g (qNineShiftV1 5))) (B (translatePacket g (qNineShiftV1 3)) (translatePacket g (qNineShiftV1 6))) (B (translatePacket g (qNineShiftV1 3)) (translatePacket g (qNineShiftV1 7))) (B (translatePacket g (qNineShiftV1 3)) (translatePacket g (qNineShiftV1 8))) (B (translatePacket g (qNineShiftV1 4)) (translatePacket g (qNineShiftV1 5))) (B (translatePacket g (qNineShiftV1 4)) (translatePacket g (qNineShiftV1 6))) (B (translatePacket g (qNineShiftV1 4)) (translatePacket g (qNineShiftV1 7))) (B (translatePacket g (qNineShiftV1 4)) (translatePacket g (qNineShiftV1 8))) (B (translatePacket g (qNineShiftV1 5)) (translatePacket g (qNineShiftV1 6))) (B (translatePacket g (qNineShiftV1 5)) (translatePacket g (qNineShiftV1 7))) (B (translatePacket g (qNineShiftV1 5)) (translatePacket g (qNineShiftV1 8))) (B (translatePacket g (qNineShiftV1 6)) (translatePacket g (qNineShiftV1 7))) (B (translatePacket g (qNineShiftV1 6)) (translatePacket g (qNineShiftV1 8))) (B (translatePacket g (qNineShiftV1 7)) (translatePacket g (qNineShiftV1 8)))
...
theorem canonical_nine_packet_fine_coercive_v1
    (z0 : ℂ) (z1 : ℂ) (z2 : ℂ) (z3 : ℂ) (z4 : ℂ) (z5 : ℂ) (z6 : ℂ) (z7 : ℂ) (z8 : ℂ) :
    (WeilExplicitRightSideV1
      (WeilAutocorrelationV1
        (ninePacketV1 gFine z0 z1 z2 z3 z4 z5 z6 z7 z8))).re ≤
      -(1083 / 640 : ℝ) * energy gFine.1 *
        energy9 ‖z0‖ ‖z1‖ ‖z2‖ ‖z3‖ ‖z4‖ ‖z5‖ ‖z6‖ ‖z7‖ ‖z8‖ :=
  nine_packet_fine_coercive_v1
    gFine 0 gFine_width_one_one_twenty_eight_v1 gFine_moments_v3
    z0 z1 z2 z3 z4 z5 z6 z7 z8

theorem canonical_nine_packet_fine_sign_v1
    (z0 : ℂ) (z1 : ℂ) (z2 : ℂ) (z3 : ℂ) (z4 : ℂ) (z5 : ℂ) (z6 : ℂ) (z7 : ℂ) (z8 : ℂ) :
    (WeilExplicitRightSideV1
      (WeilAutocorrelationV1
        (ninePacketV1 gFine z0 z1 z2 z3 z4 z5 z6 z7 z8))).re ≤ 0 := by
  have hb := canonical_nine_packet_fine_coercive_v1 z0 z1 z2 z3 z4 z5 z6 z7 z8
...
end AEGIS.RHRationalNinePacketFineConcreteV1

#print axioms AEGIS.RHRationalNinePacketFineConcreteV1.translate_fine_width_exact_v1
#print axioms AEGIS.RHRationalNinePacketFineConcreteV1.translated_fine_diagonal_v1
#print axioms AEGIS.RHRationalNinePacketFineConcreteV1.nine_packet_fine_coercive_v1
#print axioms AEGIS.RHRationalNinePacketFineConcreteV1.canonical_nine_packet_fine_coercive_v1
#print axioms AEGIS.RHRationalNinePacketFineConcreteV1.canonical_nine_packet_fine_sign_v1
