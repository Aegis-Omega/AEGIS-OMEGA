...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/multi-agent-conservative-consensus-v1"
WORK="/tmp/aegis-macc"
...
payload={
  "receipt_kind":"AEGIS_MULTI_AGENT_CONSERVATIVE_CONSENSUS_REPLAY_V1",
  "head_sha":head,
...
echo "AEGIS_MULTI_AGENT_CONSERVATIVE_CONSENSUS_REPLAY=PASS"
exit 0
