...
TEST_FILES = (
    ...
    ROOT / "sovereign-omega-v2/python/tests/test_effect_verifier_pr3.py",
    ROOT / "sovereign-omega-v2/python/tests/test_complete_verifier_pr4.py",
    ROOT / "sovereign-omega-v2/python/tests/test_complete_verifier_pr4_receipt_binding.py",
    ROOT / "sovereign-omega-v2/python/tests/test_effect_chain_main_integration.py",
)
...
def main() -> int:
    ...
    summary = {
        ...
        "proofline_scope": "PR1_THROUGH_PR4_MAIN_INTEGRATION",
        ...
        "pr2_effect_receipt_production_unavailable_asserted": passed,
        ...
        "verify_effect_asserted": passed,
        "effect_receipt_verifier_gated_asserted": passed,
        "complete_verification_asserted": passed,
        "complete_verification_receipt_binding_asserted": passed,
        "complete_verification_authority_evidence_only_asserted": passed,
        "effect_chain_security_guards_asserted": passed,
        "concurrent_file_mutation_snapshot_proof_not_established_asserted": passed,
        "atomic_admission_unavailable_asserted": passed,
        "effect_bound_admission_unavailable_asserted": passed,
        "production_admission_not_established_asserted": passed,
