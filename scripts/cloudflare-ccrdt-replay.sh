...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/conservative-consensus-crdt-v1"
...
payload={
  "receipt_kind":"AEGIS_CONSERVATIVE_CONSENSUS_CRDT_REPLAY_V1",
  "head_sha":head,
...
echo "AEGIS_CONSERVATIVE_CONSENSUS_CRDT_REPLAY=PASS"
exit 0
