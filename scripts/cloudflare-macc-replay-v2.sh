...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/multi-agent-conservative-consensus-v2"
WORK="/tmp/aegis-macc"
...
payload={
  "receipt_kind":"AEGIS_MULTI_AGENT_CONSERVATIVE_CONSENSUS_REPLAY_V2",
...
echo "AEGIS_MULTI_AGENT_CONSERVATIVE_CONSENSUS_REPLAY_V2=PASS"
exit 0
