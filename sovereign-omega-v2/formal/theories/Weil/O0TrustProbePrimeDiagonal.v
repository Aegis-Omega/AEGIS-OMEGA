(*
  DIAGNOSTIC ONLY — classical Coq Reals trust-surface probe for the
  prime-diagonal bridge.  This source is evidence about dependencies, not
  proof authority for the production Weil chain.
*)
