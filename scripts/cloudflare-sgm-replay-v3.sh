...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/sgm-proof-runner-v3"
WORK="/tmp/aegis-sgm"
...
payload={
  "receipt_kind":"AEGIS_SGM_CLOUDFLARE_REPLAY_V3",
  "transport_generation":"CLEAN_BASE_V3",
  "head_sha":head,
...
echo "AEGIS_SGM_CLOUDFLARE_REPLAY_V3=PASS"
exit 0
