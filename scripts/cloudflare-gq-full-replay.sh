...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/gq-full-proof-runner"
WORK="/tmp/aegis-gq-full"
...
write_status "START" "false" "" "full replay starting"
...
write_status "VERIFIED_EXACT_SOURCE" "true" "$LEANV"   "all Python suites passed; exact F2b source bytes compiled; axiom audit has no sorryAx"
echo "AEGIS_GQ_FULL_CLOUDFLARE_REPLAY=PASS"
exit 0
