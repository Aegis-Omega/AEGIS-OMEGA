...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/no-free-epistemic-gain-v1"
WORK="/tmp/aegis-nfeg"
...
payload={
  "receipt_kind":"AEGIS_NO_FREE_EPISTEMIC_GAIN_REPLAY_V1",
  "head_sha":head,
...
echo "AEGIS_NO_FREE_EPISTEMIC_GAIN_REPLAY=PASS"
exit 0
