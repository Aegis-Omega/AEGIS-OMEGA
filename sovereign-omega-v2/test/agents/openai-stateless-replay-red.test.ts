...
async function replayState(): Promise<WorkingCognitiveStateV1> {
  ...
  return {
    schema_version: '1.0.0',
    lineage_root: sha('1'),
    objective: 'verify stateless replay integrity',
    active_plan: [],
    hypotheses: [],
    falsified_hypotheses: [],
    unresolved_obligations: ['reject replay splicing'],
    evidence_refs: [],
    artifact_refs: [],
    next_actions: [],
