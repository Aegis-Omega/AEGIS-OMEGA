...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/no-free-epistemic-gain-v3"
WORK="/tmp/aegis-nfeg"
...
payload={
  "receipt_kind":"AEGIS_NO_FREE_EPISTEMIC_GAIN_REPLAY_V3",
  "transport_generation":"EXPLICIT_EXTENSIONALITY_V3",
...
echo "AEGIS_NO_FREE_EPISTEMIC_GAIN_REPLAY_V3=PASS"
exit 0
