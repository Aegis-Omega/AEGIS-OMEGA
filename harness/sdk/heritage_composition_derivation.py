...
``heritage_composition.py``.  This module extends that verified surface with
...
from harness.sdk import heritage_composition as _base
# Preserve the existing re-exports without importing future base-module names.
from harness.sdk.heritage_composition import (
...
# Preserve the module's pre-existing ``from ... import *`` surface while making
# intentional compatibility re-exports explicit to static analysis.
__all__ = [
    "asdict",
    "dataclass",
    "field",
    ...
    "DENIED",
    "DOM_COMPOSED_ADDITION_SET",
    "DOM_COMPOSED_OMISSION_SET",
    "DOM_COMPOSED_PRESERVATION_SET",
    "DOM_HERITAGE_COMPOSITION_RECEIPT",
    "DOM_INTERMEDIATE_INHERITED_LOSS_SET",
    "DOM_MIXED_ANCESTRY_SET",
    "DOM_PRESERVATION_COMPOSITION_PROOF",
    "DOM_TRANSIENT_ELIMINATED_SET",
    "DOM_TRANSITIVE_TRANSFORM",
    "Enum",
    "HeritageCompositionOutcomeV1",
    ...
    "DOM_DERIVATION_COMPOSITION_PROOF",
