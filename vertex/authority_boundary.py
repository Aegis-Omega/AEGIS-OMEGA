"""Outer ASGI authority membrane for AEGIS paid and webhook surfaces."""
...
class AuthorityBoundary:
    """Deny authority-bearing requests before FastAPI sees them."""
