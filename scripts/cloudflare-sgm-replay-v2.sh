...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/sgm-proof-runner-v2"
WORK="/tmp/aegis-sgm"
...
payload={
  "receipt_kind":"AEGIS_SGM_CLOUDFLARE_REPLAY_V2",
  "transport_generation":"CLEAN_BASE_V2",
  "head_sha":head,
...
write_status "VERIFIED_EXACT_SOURCE" "true" "$LEANV"   "five Python suites passed; both exact-source Lean modules compiled; axiom audit has no sorryAx"
echo "AEGIS_SGM_CLOUDFLARE_REPLAY_V2=PASS"
exit 0
