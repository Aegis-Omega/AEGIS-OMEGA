...
ROOT="$(pwd)"
ASSET_DIR="$ROOT/aegisomega-webgpu/proof-carrying-epistemic-promotion-v2"
WORK="/tmp/aegis-pcep"
...
payload={
  "receipt_kind":"AEGIS_PROOF_CARRYING_EPISTEMIC_PROMOTION_REPLAY_V2",
...
echo "AEGIS_PROOF_CARRYING_EPISTEMIC_PROMOTION_REPLAY_V2=PASS"
exit 0
